...
//        SendBird.notifyActivityPausedForOldAndroids();
    ...
    public static class SendBirdChatFragment extends Fragment {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    switch (motionEvent.getAction()){
                        case MotionEvent.ACTION_DOWN:
                            ...
                            SendBirdOpenChatActivity.start = System.currentTimeMillis();
                            //send("start");
                            return true;
                        case MotionEvent.ACTION_UP:
                            //stop vibration
                            long time = System.currentTimeMillis() - SendBirdOpenChatActivity.start;
                            send(time+"");
                            return true;
                    }
                    return false;
        ...
        private void send(String str) {
            mOpenChannel.sendUserMessage(str, new BaseChannel.SendUserMessageHandler() {
                @Override
